...
public class DefenderSequenceFormLPSolverForBoth<E> extends ZeroSumGameSolver {
	Game game;
	...
	public DefenderSequenceFormLPSolverForBoth(Game game, int playerToSolveFor) {
		this(game, playerToSolveFor, 1e-6);
	}

	public DefenderSequenceFormLPSolverForBoth(Game game, int playerToSolveFor, double tol) {
		super(game);
		this.game = game;
		try {
